...
// 🛠️ Moderadores (pueden hacer algunas cosas de admin)
export const mods = []; // Por ahora vacío, puedes poner a tus amigos jeje

// 🌟 Usuarios premium (acceso a comandos ilimitados, etc)
export const prems = []; // Aquí puedes poner IDs premium
...
// 🗂️ Carpeta donde se guardan temporales (puede ser útil si usas descargas)
export const tmpFolder = './tmp';

// 📅 Zona horaria para comandos como /hora
export const timezone = 'America/Lima';

//Despues el bot se ira mejorando uwu
